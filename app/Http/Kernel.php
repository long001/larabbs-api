...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        // 检测是否应用是否进入『维护模式』
        // 见：https://learnku.com/docs/laravel/5.5/configuration#maintenance-mode
    ...
    protected $middlewareGroups = [
        ...
        'web' => [
            ...
            // 见：https://learnku.com/docs/laravel/5.5/authentication
            ...
            // 见：https://learnku.com/docs/laravel/5.5/csrf
            \App\Http\Middleware\VerifyCsrfToken::class,

            // 处理路由绑定
            // 见：https://learnku.com/docs/laravel/5.5/routing#route-model-binding
